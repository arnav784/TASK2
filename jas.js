...
function expense(){
    ...
    var history = document.createTextNode(description  + "  ---------  " + input + "   INR  ");
    ...
    if(input == "" )
    {
        ...
        cbalance.innerHTML = closing_balance + " .00 INR" ;
        income.innerHTML = closing_balance + " .00 INR";
    ...
    else if(input<0)
    {
     ...
     document.getElementById("expense").innerHTML = (exp_balance - input)+ " .00 INR";
     document.getElementById("cbalance").innerHTML = total_amount + " .00 INR"
    }
